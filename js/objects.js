(function () {
    ...
    shoppers.forEach((shopper) => {
        if (shopper.amount > 200) {
            console.log(shopper.name + ": spent: $" + shopper.amount + " discount: 12% discounted price: $" + (shopper.amount * .88).toFixed(2));
        } else {
            console.log(shopper.name + ": spent: $" + shopper.amount + " discount: none");
        }
    });
